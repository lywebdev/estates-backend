...
class OwnerController extends Controller
{
    public static function standard($data)
    {
        ...
        $date = date('d.m.Y');
        $time = date('i:s');
        // Сначала вносим в бд - потом генерим. всё делаем в транзакции, если вощникает возникает ошибка при генерации pdf - исключение и удаляем из бд этот договор
        ...
        $filename = "owner-standard-" . $createdAgreement->id . ".pdf";
