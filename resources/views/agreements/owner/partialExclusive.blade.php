                ...
                <div class="ac-grid">
                    <div class="row">
                        <div class="col-sm-12 col-md-8">
                            <div class="section__title">Договор: Частичный эксклюзив для Собственника</div>
                        </div>
                    </div>
                    <div class="agreement-form__form">
                        <form action="{{ route('agreements.sign', [$agreement['type'], $agreement['subtype']]) }}" method="post">
                            ...
                            <div class="form__item">
                                <label for="agreement_end_date">Срок окончания договора</label>
                                <input type="date" class="input" placeholder="Укажите дату" name="agreement_end_date" id="agreement_end_date">
                            </div>
                            <div class="form__item">
