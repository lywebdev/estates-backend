                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Санузлы</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                @if ($bathrooms)
                                        ...
                                        @foreach ($bathrooms as $bathroom)
                                            <tr>
                                                ...
                                                <th class="table__btns">
                                                    <a href="{{ route('admin.estates.bathrooms.edit', $bathroom->id) }}" class="btn btn-outline-dark btn-flat mr-2">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('admin.estates.bathrooms.destroy', $bathroom->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
