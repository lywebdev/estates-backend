...
@section('content')
    <section id="content" class="page__service-cost">
        <div class="breadcrumbs">
            ...
            <div class="ac-grid">
                <div class="breadcrumbs__path">
                    ...
                    <span class="breadcrumbs__item breadcrumbs__current">Стоимость услуг</span>
                </div>
                <div class="breadcrumbs__title">Стоимость услуг</div>
            </div>
        </div>

        <section class="section what-included">
            <div class="container-fluid">
                <div class="ac-grid">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="section-h1">
                                <span>Что входит в </span>
                                <span>стоимость услуг?</span>
                            </h1>
                        </div>

                        <div class="row gy-4">
                            <div class="col-md-6 col-lg-3 what-included__item">
