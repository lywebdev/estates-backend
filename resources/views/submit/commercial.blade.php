                                            ...
                                            <div class="ac-text">
                                                ...
                                                <div class="row app-submission__option-select">
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-xl-2">
                                                        <div class="form-label checkbox-block">Мебель</div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-xl-2">
                                                        <div class="form-label checkbox-block">Паркинг</div>
                                                        <div class="radio-container f ai-c">
                                                            <div class="radio-input mr-15">
                                                ...
                                                <div class="row app-submission__option-section">
                                                    <div class="col-md-4">
                                                        <label for="transformer_substation" class="form-label">Собственная ТП</label>
                                                        <input type="text" class="input" name="transformer_substation" id="transformer_substation">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="electricity_max" class="form-label">Максимальное потребление эл-ва</label>
                                                        <input type="text" class="input" name="electricity_max" id="electricity_max">
                                                    </div>
                                                </div>

                                                <div class="row app-submission__option-section">
                                                    <div class="col-md-4">
                                                        <div class="form-label checkbox-block">Санузел</div>
                                                        <div class="select bathroom-select"></div>
                                                    </div>
                                                    <div class="col-md-4 col-lg-4 col-xl-2">
                                                        <div class="form-label">ЖД Тупик</div>
                                                        <div class="radio-container f ai-c">
                                                            <div class="radio-input mr-15">
                                                                <input type="radio" name="zd_deadend" id="zd_deadend_yes" class="zd_deadend-input" value="yes">
                                                                <label for="zd_deadend_yes"><span>Да</span></label>
                                                            </div>
                                                            <div class="radio-input">
                                                                <input type="radio" name="zd_deadend" id="zd_deadend_no" class="zd_deadend-input" value="no" checked>
                                                                <label for="zd_deadend_no"><span>Нет</span></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
