    ...
    <div class="sortable form__sortable">
        <div class="sortable__items row">
            ...
            <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="col-md-12">
                    @if (url()->current() == route('submit', 'flats'))
                    ...
                    @else
                        <a class="sortable__item" href="#">Квартиры</a>
                    @endif
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="col-md-12">
                    @if (url()->current() == route('submit', 'houses'))
                        <div class="sortable__item sortable__item--selected">
                    ...
                    @else
                        <a class="sortable__item" href="{{ route('submit', 'houses') }}">Дом/участок</a>
                    @endif
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="col-md-12">
                    @if (url()->current() == route('submit', 'commerces'))
                        <div class="sortable__item sortable__item--selected">
                    ...
                    @else
                        <a class="sortable__item" href="{{ route('submit', 'commerces') }}">Коммерция</a>
                    @endif
                </div>
            </div>
